    ...
    def __init__(self, outlinesWeightsFile, outlinesModel='deeplab_resnet', imgHeight=288, imgWidth=512):
        ...
        if outlinesModel == 'unet':
            ...
            raise NotImplementedError(
                'Model may only be "unet" or "deeplab_resnet". Given model is: {}'.format(outlinesModel))
...
class InferenceMasks():
    ...
    def __init__(self, masksWeightsFile, masksModel='deeplab_resnet', imgHeight=288, imgWidth=512):
        '''Class to run Inference of the Outlines Prediction Model
