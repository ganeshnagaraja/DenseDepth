...
class DepthToDepthCompletion(object):
    ...
    def __init__(
        ...
        self.inferenceNormals = inference_models.InferenceNormals(normalsWeightsFile=normalsWeightsFile,
                                                                  ...
                                                                  imgHeight=self.outputImgHeight,
                                                                  imgWidth=self.outputImgWidth)
    ...
    def store_depth_completion_outputs(self, root_dir, files_prefix, min_depth=0.0, max_depth=1.5):
        ...
        input_depth_rgb = utils.depth2rgb(self.input_depth, min_depth=min_depth, max_depth=max_depth)
        orig_input_depth_rgb = utils.depth2rgb(self.orig_input_depth, min_depth=min_depth, max_depth=max_depth)
        output_depth_rgb = utils.depth2rgb(self.output_depth, min_depth=min_depth, max_depth=max_depth)
        ...
        grid_image2 = np.concatenate(
            (orig_input_depth_rgb, input_depth_rgb, output_depth_rgb, filtered_output_depth_rgb), 1)
    ...
    def _modify_depth_delete_masks(self, rgb_image, input_depth):
        ...
        mask = self.inferenceMasks.runOnNumpyImage(rgb_image)
